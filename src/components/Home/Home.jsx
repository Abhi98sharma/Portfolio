export default function Home() {
  return (
    <>
      <main
        id="home"
        className="min-h-screen bg-black flex justify-between items-center px-20 py-32 bg-image relative"
      >
        <div className="flex flex-col">
          <div className="w-[820px] h-[315px] space-y-4">
            <div className="flex items-end">
              <h1 className="text-[25px] text-[#fff] font-Kameron font-semibold">
                Abhijeet Sharma
              </h1>
              <img
                className="mb-2 pl-2"
            ...
            <h1 className="text-[59px] font-Quicksand name-heading">
              Front-end Developer
            </h1>
