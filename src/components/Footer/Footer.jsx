      ...
      <footer class="text-gray-600 body-font bg-[#111111] font-Inter px-5">
        <div class="container px-5 py-5 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            <a href='https://github.com/Abhijeet03s' target="_blank" class="text-gray-500">
              <img width={24} src="/socials-icon/github.png" alt="" />
            </a>
            <a href='https://www.linkedin.com/in/abhijeet-sharma03/' target="_blank" class="ml-3 text-gray-500">
              <img width={24} src="/socials-icon/linkedin.png" alt="" />
            </a>
            <a href='https://twitter.com/abhijeet_s04' target="_blank" class="ml-3 text-gray-500">
